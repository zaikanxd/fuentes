...
const kStorage ='micronegocios' ;
// const kPrimaryColor = Color(0xFF00A132);//microbank;
const kPrimaryColor = Color(0xFF219EA7); //Piura;
...
const port = (kEntorno == 'prod') ? '8090' : '8040';
